...
<head>
  ...
  <title>@yield('title') - Oppopasal</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3">Oppopasal Admin <sup>2</sup></div>
      </a>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="{{URL::to('/category/view')}}">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Category</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{URL::to('/manufacture/view')}}">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{URL::to('/product/view')}}">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="{{URL::to('/slider/view')}}">
          <i class="fas fa-fw fa-table"></i>
          <span>Slider</span></a>
      </li>
