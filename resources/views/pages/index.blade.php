<?php
 $slider_data = DB::table('tbl_slider')->where('publication_status',1)->limit(3)->get();
        ...
        <div class="container col-sm-12">
            ...
            <div class="col padding-right">
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item {{ $loop->first ? 'active' : '' }}">
                            <div class="col-sm-6">
                                <h1><span>E</span>-Oh Yo Pasal</h1>
                                <h2>Choose, Order , Get</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                <button type="button" class="btn btn-default get">Get it now</button>
                            </div>
                            <div class="col-sm-6">
                                <img src="{{URL::to('images/slider/image/'.$result->slider_image)}}" class="girl img-responsive" alt="" />
                ...
                <div class="features_items"><!--features_items-->
                    ...
                    @foreach($all_published_product as $result)
                    <div class="col-sm-4">
