...
<head>
    ...
    <meta name="author" content="">
     <title>Oppopasal | @yield('title')</title>
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{url('/cart')}}"><i class="fa fa-shopping-cart"></i> Cart<small class="cart-count">{{Cart::getContent()->count()}}</small></a></li>
                            ...
                            @foreach($category_data as $result)
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="{{URL::to('/category/'.$result->category_id)}}">{{$result->category_name}}</a></h4>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="brands-name">
                                    <ul class="nav nav-pills nav-stacked">
                                         @foreach($manufacture_data as $result)
                                             <li><a href="{{URL::to('/manufacture/'.$result->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$result->manufacture_name}}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div><!--/brands_products-->
